...
public class TagService : ITagService
{
    ...
    public TagService(ApplicationDbContext context, ILogger<TagService> logger, IAuditService auditLogger)
    {
        _context = context;
        _logger = logger;
        ...
        int pageSize = 10)
    {
        try
        {
            ...
            return new PagedResponse<TagDto>(tagsData, page, pageSize, totalCount);
        }
        catch (Exception ex)
        {
